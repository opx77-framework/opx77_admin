--- Player-facing text. Log lines stay English whatever the configured locale is, and so does
--- what a command answers the console. Publishes the global `locale(key, params)` and
--- `OpxAdmin.Locale`.
